defmodule PhoenixWithRailsSession.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PhoenixWithRailsSession.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PhoenixWithRailsSession.ErrorHelpers.translate_error/1)
